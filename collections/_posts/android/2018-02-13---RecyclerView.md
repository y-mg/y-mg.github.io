...
이를 보완하기 위해 나온 <code style="color: #eb5657;">RecyclerView</code> 는 화면에 보이는 정도의 뷰 객체를 생성하고 스크롤 시 사라지는 뷰를 삭제하는 것이 아니라 새로 그려져야할 뷰가 있는 위치로 <code style="color: #eb5657;">ViewHolder</code> 를 이동시켜 재사용한다.
<br/>
